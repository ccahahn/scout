...
#### Overwhelm check
- [ ] Are there at most 3 top recommendations? If Scout sent more than 3, move the extras to `near_misses` and keep only the strongest in `grants`.
- [ ] Are there at most 2 near-misses? No more than 5 items total (3 grants + 2 near-misses).
